# file: robodog_terminal/test_background.py
"""
Self-test for robodog_terminal/background.py (BackgroundManager).
...
Run:  python robodog_terminal/test_background.py        (from robodogcli/robodog/)
"""
...
from robodog_terminal.background import BackgroundManager, BgTask  # noqa: E402

# Test 3 fails a task on purpose; keep its logged traceback out of the output.
logging.getLogger("robodog_terminal.background").addHandler(logging.NullHandler())
logging.getLogger("robodog_terminal.background").propagate = False
