...
class ConsoleService {
  constructor() {
    this._options = [
      ...
      { command: "/analyze callgraph", description: "Build call graph for codebase." },
      { command: "/analyze impact <fn>", description: "Find what breaks if function changes." },
      { command: "/analyze deps <file>", description: "Show file dependencies." },
      { command: "/analyze stats", description: "Show codebase statistics." },
      { command: "/cascade run <task>", description: "Run task with parallel execution (Windsurf-style)." },
