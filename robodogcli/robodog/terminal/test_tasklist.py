# file: terminal/test_tasklist.py
"""
Self-test for terminal/tasklist.py: TaskChecklist, register_task_tools, and
register_ask_tool. Exercises every method and branch against a real
ToolRegistry from terminal.tools.default_registry.

Run:  python terminal/test_tasklist.py         (from robodogcli/robodog/)
   or: python -m robodog.terminal.test_tasklist (from robodogcli/)
"""
...
try:
    ...
    from terminal.tasklist import (TaskChecklist, TaskItem, register_ask_tool,
                                   register_task_tools)
