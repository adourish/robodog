...
Run: python terminal/test_app.py   (from robodogcli/robodog)
"""
...
def main() -> int:
    ...
    from terminal.checkpoint import Checkpointer, MAX_SNAPSHOTS
    ...
    from terminal.background import BackgroundManager as BM
    bm = BM()
    t0 = time.time()
