# file: terminal/test_sessions.py
"""
Self-test for terminal/sessions.py (SessionStore) — JSONL session persistence.
...
Run:  python terminal/test_sessions.py        (from robodogcli/robodog/)
"""
...
# Support both "python -m robodog.terminal.test_sessions" and direct execution.
try:
