...
Run:
  python -m robodog.terminal.app            (from robodogcli/)
  python terminal/app.py                    (from robodogcli/robodog/)
"""
...
try:
    ...
    from terminal.llm_client import EchoClient, ElsaClient, LLMClient, OpenAICompatClient
    from terminal.tools import default_registry
    from terminal.loop import AgentLoop
    from terminal.ui import UI
    from terminal.agents import register_agent_tool
...
def _mk_turn(role: str, content: str, tool_name: str = ""):
    try:
        ...
        from terminal.loop import Turn
...
def _make_checkpointer():
    try:
        ...
        from terminal.checkpoint import Checkpointer
    import time as _t
...
def main(argv=None) -> int:
    ...
    try:
        ...
        from terminal.background import BackgroundManager
    ...
    try:
        ...
        from terminal.skills import SkillsRegistry
        from terminal import agents as _agents_mod
    ...
    try:
        ...
        from terminal.tasklist import TaskChecklist, register_task_tools, register_ask_tool
    ...
    try:
        ...
        from terminal.turnrunner import TurnRunner, make_key_source
        ...
        if line.startswith("/"):
            ...
            if cmd in ("exit", "quit", "q"):
                ...
                try:
                    ...
                    from terminal.doctor import run_doctor, format_report
