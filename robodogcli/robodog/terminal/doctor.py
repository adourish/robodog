...
Run:  python -m robodog.terminal.doctor       (from robodogcli/)
   or: python terminal/doctor.py              (from robodogcli/robodog/)
"""
...
# ELSA dev defaults (endpoint/engine are not secrets — mirrors terminal/app.py).
