# file: terminal/test_skills.py
"""
Offline unit tests for terminal/skills.py — frontmatter parsing, discovery of
custom commands / agents / skills across project and user roots, command
substitutions, and the accessor/summary API.

Run:  python terminal/test_skills.py        (from robodogcli/robodog/)
   or: python -m robodog.terminal.test_skills
...
logging.getLogger("terminal.skills").setLevel(logging.CRITICAL)

# Support both "python -m robodog.terminal.test_skills" and direct execution.
try:
    from .skills import (
        CustomCommand,
        SkillsRegistry,
...
def main() -> int:
    ...
    try:
        ...
        import terminal.skills as skills_mod
