...
Run:  python -m robodog.terminal.selftest      (from robodogcli/)
   or: python terminal/selftest.py             (from robodogcli/robodog/)
"""
...
# Support both "python -m robodog.terminal.selftest" and direct execution.
try:
    ...
    from terminal.llm_client import EchoClient
...
def main() -> int:
    ...
    from terminal.agents import _child_registry
