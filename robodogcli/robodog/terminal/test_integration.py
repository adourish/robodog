# file: terminal/test_integration.py
"""
...
Run: python terminal/test_integration.py   (from robodogcli/robodog)
"""
...
from terminal.tasklist import (TaskChecklist,          # noqa: E402
...
def main() -> int:
    ...
    # ---------------- @-mentions ----------------------------------------
    from terminal.app import _expand_mentions
