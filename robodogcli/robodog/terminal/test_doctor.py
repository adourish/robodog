# file: terminal/test_doctor.py
"""
Tests for terminal/doctor.py — the /doctor environment diagnostics.
...
Run:  python terminal/test_doctor.py          (from robodogcli/robodog/)
   or: python -m robodog.terminal.test_doctor (from robodogcli/)
"""
...
# Support both "python -m robodog.terminal.test_doctor" and direct execution.
try:
    from . import doctor
    from .doctor import CheckResult, format_report, run_doctor
except ImportError:
    sys.path.insert(0, str(Path(__file__).resolve().parent.parent))
    from terminal import doctor
    from terminal.doctor import CheckResult, format_report, run_doctor
...
def main() -> int:
    ...
    try:
        ...
        check(mod_fail.ok is False
              and "terminal.no_such_terminal_module_xyz failed" in mod_fail.detail,
